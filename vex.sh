...
TEMP_DIR=""  # 将在初始化时设置
ACTIVE_ACCOUNT_PREFIX=""  # 账户前缀，将在初始化时设置
...
check_env() {
    ...
    # 提取邮箱前缀作为账户前缀
    ACTIVE_ACCOUNT_PREFIX=$(extract_email_prefix "$active_account")
    log "SUCCESS" "环境检查通过 (账号: ${active_account}, 前缀: ${ACTIVE_ACCOUNT_PREFIX})"
...
vertex_main() {
    ...
    echo -e "    账户前缀: ${ACTIVE_ACCOUNT_PREFIX}"
    echo -e "======================================================${NC}\n"
